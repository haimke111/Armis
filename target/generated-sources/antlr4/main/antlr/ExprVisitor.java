...
public interface ExprVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code assignWithOp}
	 * labeled alternative in {@link ExprParser#stat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssignWithOp(@NotNull ExprParser.AssignWithOpContext ctx);
	 ...
	 * @return the visitor result
	 */
	T visitIncDec(@NotNull ExprParser.IncDecContext ctx);
